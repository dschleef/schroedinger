...
class PlayerWindow(gtk.Window):
    ...
    def create_ui(self):
        ...
        combobox.append_text("Daubechies 9,7")
        ...
        hscale = gtk.HScale(gtk.Adjustment(10,0,100,1,1,1))
        hscale.connect('value-changed', self.hscale_value_changed_cb)
        hbox.pack_start(hscale, True)
