...
void orc_haar_sub_s16 (int16_t *d1, int16_t *d2, int n);
void orc_haar_add_half_s16 (int16_t *d1, int16_t *d2, int n);
void orc_haar_add_s16 (int16_t *d1, int16_t *d2, int n);
void orc_haar_sub_half_s16 (int16_t *d1, int16_t *d2, int n);
