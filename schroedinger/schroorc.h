...
void orc_add2_rshift_add_s16_22 (int16_t *d, int16_t *s2, int16_t *s3, int n);
void orc_add2_rshift_sub_s16_22 (int16_t *d, int16_t *s2, int16_t *s3, int n);
void orc_add2_rshift_add_s16 (int16_t *d, int16_t *s1, int16_t *s2, int16_t *s3, int16_t *s4_2, int n);
void orc_add2_rshift_add_s16_11 (int16_t *d, int16_t *s2, int16_t *s3, int n);
void orc_add2_rshift_sub_s16_11 (int16_t *d, int16_t *s2, int16_t *s3, int n);
...
void orc_mas2_sub_s16_ip (int16_t *d1, int16_t *s2, int mult, int offset,
    int shift, int n);
void orc_mas4_add_s16_1991 (int16_t *d1, int16_t *s2, int shift, int n);
void orc_mas4_sub_s16_1991 (int16_t *d1, int16_t *s2, int shift, int n);
...
void orc_multiply_and_add_s16_u8 (int16_t *d, int16_t *src2,
    uint8_t *src3, int n);
