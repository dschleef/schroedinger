...
typedef enum {
  ...
  SCHRO_ENCODER_FRAME_STATE_ENGINE_1 = (1<<7),
  SCHRO_ENCODER_FRAME_STATE_FREE = (1<<8),
  SCHRO_ENCODER_FRAME_STATE_HAVE_REFS = (1<<9),
  SCHRO_ENCODER_FRAME_STATE_HAVE_PARAMS = (1<<10)
