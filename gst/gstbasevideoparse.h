 ...
 */
#define GST_BASE_VIDEO_PARSE_SRC_PAD(obj)         (GST_BASE_VIDEO_PARSE_CAST (obj)->srcpad)
 ...
 */
#define GST_BASE_VIDEO_PARSE_SINK_PAD(obj)        (GST_BASE_VIDEO_PARSE_CAST (obj)->sinkpad)

/**
 * GST_BASE_VIDEO_PARSE_NEED_DATA:
 *
 */
