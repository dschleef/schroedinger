...
/**
 * GST_BASE_VIDEO_ENCODER_SRC_PAD:
 * @obj: base video coder instance
 *
 * Gives the pointer to the source #GstPad object of the element.
 */
#define GST_BASE_VIDEO_ENCODER_SRC_PAD(obj)         (GST_BASE_VIDEO_ENCODER_CAST (obj)->srcpad)

/**
 * GST_BASE_VIDEO_ENCODER_SINK_PAD:
 * @obj: base video coder instance
 *
 * Gives the pointer to the sink #GstPad object of the element.
 */
#define GST_BASE_VIDEO_ENCODER_SINK_PAD(obj)        (GST_BASE_VIDEO_ENCODER_CAST (obj)->sinkpad)
